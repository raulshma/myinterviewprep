...
interface RoadmapProgressCardProps {
  progress: UserRoadmapProgressSummary;
}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 space-y-6">
          <div className="flex items-start justify-between">
             <div className="flex items-center gap-3">
                ...
                <div>
                    <h3 className="font-bold text-lg text-foreground">Active Roadmap</h3>
                     <p className="text-xs text-muted-foreground capitalize line-clamp-1 max-w-[200px]">{progress.roadmapSlug.replace(/-/g, " ")}</p>
                </div>
             </div>
      ...
      <div className="relative z-10 space-y-4 mt-4">
          ...
          >
            <Link href={`/roadmap/${progress.roadmapSlug}`}>
              Continue Roadmap
