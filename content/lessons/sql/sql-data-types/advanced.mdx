...
Row Storage Layout:
┌─────────┬─────────┬──────────┬───────────────┐
│ Fixed   │ Variable│ NULL     │ Variable      │
│ Length  │ Length  │ Bitmap   │ Data          │
│ Columns │ Count   │          │               │
└─────────┴─────────┴──────────┴───────────────┘

-- INT (fixed 4 bytes) vs VARCHAR (2 bytes overhead + data)
```
...
<ProgressCheckpoint section="advanced-data-types" xpReward={55} />
