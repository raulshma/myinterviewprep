...
<KeyConcept title="CI Cardinal Rules">
  1. **Never break the build** — Fix it immediately if you do
  2. **Commit frequently** — Small changes are easier to debug
  3. **Don't commit broken code** — Run tests locally first
  4. **Write automated tests** — Manual testing doesn't scale
</KeyConcept>
...
- 🧪 **Test automation** catches bugs before production
