...
- 🧩 **Composite actions** create modular, reusable steps
- 🖥️ **Self-hosted runners** for enterprise requirements
- 🐳 **Docker deployment** with layer caching for speed
- 🔐 **OIDC authentication** eliminates stored credentials
- 🛡️ **Security hardening** with minimal permissions and pinned versions
