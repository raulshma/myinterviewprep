...
console.log(obj._secretData); // Works! Not really private 😬
```
...
```javascript
class Example {
  #declared = 'ok';  // ✅ Declared at class level
  
  constructor() {
    // this.#notDeclared = 'error';  // ❌ SyntaxError!
    this.#declared = 'modified';     // ✅ Can modify declared field
  }
}
```
...
console.log('\\n⚠️ Private fields are NOT inherited!');
