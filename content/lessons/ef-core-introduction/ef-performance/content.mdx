...
Imagine your database is a library, and EF Core is your librarian. A slow librarian doesn't just annoy one person—they create a line that grows and grows until the whole library grinds to a halt!
...
|:-----------|:-------------|:--------------|
| **Query Translation** | LINQ → SQL compilation is slow | First query is slow, subsequent fast |
...
Before optimizing, you must **measure**. Never guess where the slowness is—profile first, optimize second!
</KeyConcept>
  ...
  steps={[
    {
      ...
      explanation: "This doesn't execute anything—just builds an expression tree"
    },
    {
      lineNumbers: [10, 11],
    ...
    },
    {
      ...
      explanation: "Complete SQL with parameters—copy to your database tool!"
    }
  ]}
/>
...
// - Easy filtering in profiler tools`}
  steps={[
    ...
    },
    {
      ...
      explanation: "Tags become SQL comments—visible in any profiler!"
    }
  ]}
/>
...
-- Only 2 columns transferred!`,
      explanation: "Projection reduces data to exactly what's needed—often 10-100x less data!"
    }
  ]}
/>
  ...
  steps={[
    {
      ...
      explanation: "EF can't see inside your method—loads everything to filter in C#!"
    },
    {
    ...
    },
    {
      ...
      explanation: "Keep expressions simple—EF can translate comparison operators"
    },
    {
...
// Check with: .ToQueryString() → SSMS execution plan
