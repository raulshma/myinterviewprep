...
Every entity has a Primary Key (PK) to identify it. But sometimes, you have *other* properties that identify a record uniquely – like an Email Address, a Vehicle VIN, or an ISBN. These are **Alternate Keys**.
