...
⚠️ **Here is the Danger:** If you modify `Product.cs` directly, and then run the scaffold command again to get updates from the database... **POOF!** 💨 Your changes are overwritten and lost forever.
